...
<body style="min-height:180vh;display:flex;flex-direction:column;">
  ...
  <h1 style="border: 0px solid #FFFFFF; background:white;text-align:center;color:ivory;font-family:arial;font-size:5vw;font-style:italic;text-shadow: 3px 3px 8px #000000;">
    <p class="tracking-in-expand"> QUI SOMMES NOUS ?</p>
  </h1>

  <br>

  <h1 style="border: 0px solid #FFFFFF;text-align:center;color:ivory;font-family:arial;font-size:2vw;font-style:italic;text-shadow: 3px 3px 8px #000000;">
    <p class="text-focus-in"> PRÉSENTATION </p>
  </h1>
  <br>
  ...
  <h1 style="border: 0px solid #FFFFFF;text-align:center;color:ivory;font-family:arial;font-size:2vw;font-style:italic;text-shadow: 3px 3px 8px #000000;">
    <p class="text-focus-in"> NOTRE MISSION </p>
  </h1>
  <br>
  <div style="display: flex; padding-left:50px; padding-right:50px; align-items:center">
    <span style="padding-left:50px; padding-right:50px; align-items:center">
      <ul>
        ...
        <br>
        <div>
          <button data-toggle="collapse" data-target="#demo" class="btn btn-primary border">Nos Missions ‎ ‎</button>
          ...
          <br>
          <br>
          <button data-toggle="collapse" data-target="#demo" class="btn btn-primary border">Nos Garanties</button>
          <div id="demo" class="collapse">
  ...
  <h1 style="border: 0px solid #FFFFFF;text-align:center;color:ivory;font-family:arial;font-size:2vw;font-style:italic;text-shadow: 3px 3px 8px #000000;">
    <p class="text-focus-in"> NOTRE ÉQUIPE </p>
  </h1>
  <br>
