...
@$submit = $_POST['submit'];
 ...
 if (isset($_POST['submit']) && !empty($name) && !empty($mail) && !empty($phone) && !empty($msg)) { 
    ...
    $insert->execute(array(
      ...
      @$mail = "x225franc@gmail.com";
      @$subject ="[SAFESECUR] - Nouveau contact !"; 
      @$message =
      
      ' 
      <span style="color:red;font-size:25px";>/!\NE PAS RÉPONDRE/!\</span> <br> <br>
      
      <span style="color:green;font-size:20px;">Nouveau contact.</span><br><br>
      
      <strong>Nom complet : </strong> '.$q['name'].'.<br><br>
      
      <strong>Email : </strong> '.$q['mail'].'.<br><br>
      
      <strong>Contact : </strong> '.$q['phone'].'.<br><br>
      
      <strong>Message : </strong> '.$q['msg'].'.<br><br>
      
      <i style="text-align:center;font-size:12px;color: rgba(234, 240, 246, 0.1)">SAFESECUR © '.@date('Y').' Copyright</i> ';
      ...
      <div class="col-md-6">
        ...
        <form method="post">
          <div class="row">
            ...
            <div class="col-12">
            <input type="submit" name="submit" class="btn bnt-light" value="ENVOYER" />
            </div>
          </div>
        </form>
